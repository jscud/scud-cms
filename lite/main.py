  ...
  def get(self):
    ...
    self.response.out.write('<html><body>'
        '<form action="/content_manager" method="post">'
          '<table><tr><td>'
          'Path:</td><td><input type="text" name="path" size="80" value="%s">'
          '</td></tr><tr><td>'
          'Type:</td><td><input type="text" name="type" size="80" value="%s">'
          '</td></tr><tr><td>'
          'Updated:</td><td><input type="text" name="updated" size="80"'
          ' value="%s">'
          '</td></tr><tr><td>'
          'Cache:</td><td><input type="text" name="cache" value="%s">'
          '</td></tr></table>'
          'Content:<br/>'
